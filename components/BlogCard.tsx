...
export default function BlogCard({ blog_title, published_date, tags} : BlogCardType) { 
    ...
    return (
        <div id='blog-card' className="rounded-lg mx-2 my-2">
            <Link href={blogRoute(blog_title)} className="prose"><span id='blog-title' className="text-4xl font-semibold hover:text-teal-500 dark:text-blue-400 dark:hover:text-red-500">{blog_title}</span></Link>
